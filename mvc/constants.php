<?php
	...
	*/
	...
	//On définit les chemins
        define('PWD', '/var/www/html/secure_password/'); //On défini le chemin de base du site
	define('HTTP_PWD', (isset($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . (isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : 'localhost') . '/secure_password/'); //On défini l'adresse url du site
	...
	//Réglages divers
	define('WEBSITE_TITLE', 'Secure Password'); //Le titre du site
	define('WEBSITE_DESCRIPTION', 'Protégez vos passwords en les chiffrants !'); //Description du site
	define('WEBSITE_KEYWORDS', 'mot de passe, aes, chiffrement'); //Mots clefs du site
	define('WEBSITE_AUTHOR', 'Ajani'); //Auteur du site

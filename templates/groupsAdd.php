<div id="groups-add" class="tile">
	...
	<form class="col-xs-10 col-xs-offset-1 col-md-6 col-md-offset-3 add-form ajax-form" method="POST" action="<?php secho($this->generateUrl('groups', 'create', [$_SESSION['csrf']])); ?>" target="<?php secho($this->generateUrl('groups')); ?>" target-id="groups">
